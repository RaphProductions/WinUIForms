...
namespace WinUIForms
{
    public class DWMUtil
    {
        internal struct MARGINS
        {
            ...
            {
                this.cxLeftWidth = cxWidth;
                this.cxRightWidth = cxWidth;
                this.cyTopHeight = cxHeight;
                this.cyBottomHeight = cxHeight;
            }
            public MARGINS(int cxGlobal)
            {
                this.cxLeftWidth = cxGlobal;
                this.cxRightWidth = cxGlobal;
                this.cyTopHeight = cxGlobal;
                this.cyBottomHeight = cxGlobal;
            }
        }
        ...
        [DllImport("dwmapi.dll", PreserveSig = true)]
        internal static extern void DwmExtendFrameIntoClientArea(System.IntPtr hWnd, MARGINS margins);

        public static void SetSystemBackdrop(IntPtr hwnd, SystemBackdrop bdrop, bool ShowInClientArea = true)
        {
            if (ShowInClientArea)
